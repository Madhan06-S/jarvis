...
import { initBuilderUI, appendLog, handleCodeStreamStart, handleCodeStreamChunk, handleBuildComplete } from './builder-ui';
...
function main() {
    ...
    socket.onMessage(msg => {
        if (msg.type === "audio" && msg.data) {
            ...
            handleCodeStreamChunk(msg.text);
            ...
            handleBuildComplete((msg.project_name as string) || "project", url);
